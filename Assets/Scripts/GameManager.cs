...
public class GameManager : MonoBehaviour
{
    ...
    bool m_hasQuestionActive = false;
    public bool HasQuestionActive { get { return m_hasQuestionActive; } set { m_hasQuestionActive = value; } }
    ...
    bool IsQuestion()
    {
        if (m_board.PlayerNode != null)
        {
            return (m_board.PlayerNode == m_board.quizNode);
        }
        return false;
    }
