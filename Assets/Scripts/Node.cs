...
public class Node : MonoBehaviour
{
    ...
    public bool isLevelQuiz = false;
    public bool isReactiveNode = false;
    ...
    void Awake()
    {
        ...
        if (isReactiveNode == true)
        {
            gameObject.tag = "reactiveNode";
        }
    }
    ...
    public void NodeStart(GameObject reactiveNode){
